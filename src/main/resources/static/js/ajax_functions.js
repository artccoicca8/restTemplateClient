      ...
      if(transbank){ // POST
        ...
        versioningDataJson["acquirerMerchantID"] = accMerchantId;
    ...
    function authentication(){
      ...
      // var urlEnviroment =
		// "http://172.19.44.106:4567/restapis/ez9mbph7no/local/_user_request_/tds-alignet-requestor-rest/authentication"
      ...
      headers["threeDSServerTransID"] = threeDSServerTransIDsTring;
        ...
        $.ajax({
            type: "POST",
          // url:
			// "https://uatrequestor.3dsecurekey.cloud/tds-alignet-requestor-rest/api/v2/authentication",
            url: urlEnviroment,
            headers:headers,
